    ...
    <div className={styles.container}>
      ...
      <div className="flex flex-col min-h-screen justify-between flex-wrapper">
        <header>
          <nav className="items-center justify-between flex-wrap bg-black p-6">
            ...
            <div className="text-right items-center flex-shrink-0 text-white float-right addProductBtn">
              <span className="font-semibold text-xl tracking-tight"><button type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Add a product</button>
              </span>
            </div>
          </nav>
        </header>
        <main className="mb-auto">
          ...
          <div class="relative h-32 w-32 float-right userIcon">
            <div class="absolute bottom-0 right-0 h-16 w-16">
              <Image src={userPic} onClick={() => {
              }} />
            </div>
          </div>
        </main>
