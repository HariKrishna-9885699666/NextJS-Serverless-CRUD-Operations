                    ...
                    <div className="pt-6">
                        <div className="mx-auto mt-6 max-w-4xl sm:px-6">
                            <div className="aspect-w-3 aspect-h-4 hidden overflow-hidden rounded-lg lg:block">
                                <Image src={image} alt="Two each of gray, white, and black shirts laying flat." className="h-full w-full" width="100%" height="100%" layout="responsive" objectFit="contain" loading="lazy"/>
                            </div>
                        </div>
